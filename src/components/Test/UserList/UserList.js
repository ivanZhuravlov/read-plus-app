      ...
      formatter: (cellContent, user) => (
        <>
          <h5 className="font-size-14 mb-1">
            <Link to={pathRoutes.SCHOOL_CLASSES} className="text-dark">
              {user.name}
            </Link>
          </h5>
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Task | Read Plus</title>
        </MetaTags>
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="Task" breadcrumbItem="Task" />
                        ...
                        >
                          {toolkitProps => (
                            <React.Fragment>
                              <Row className="mb-2">
                                <Col sm="2">
                                  <p className="h5 mb-1">Assigned students</p>
                                </Col>
                                <Col sm="4">
