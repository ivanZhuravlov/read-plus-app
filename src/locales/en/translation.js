export default {
  "The world's most advanced reading app":
    "The world's most advanced reading app",
  Welcome: "Welcome!",
  "Sign in to continue to Read Plus": "Sign in to continue to Read Plus.",
  ...
  "logout confirmation msg": "Are you sure you want to log out?",
  "send link success msg":
    "A confirmation letter has been sent to the specified mail.",
  "invalid user email msg":
    "The user with this e-mail is not registered. Check the entered email.",
  "invalid link msg":
    "This link is no longer valid. Please try logging in again.",
  "auth error msg": "Authorization error. Please try to login later.",
  "invalid user email lock msg":
    "Invalid user email. Check the email you entered.",
